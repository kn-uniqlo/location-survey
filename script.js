  ...
  function populateSearch() {
    ...
    searchInput.addEventListener('change', function() {
      ...
      if (selected) {
        loadNewPdf(selected.id);  // Use selected.id instead of pdfUrl
      }
    });
  }
